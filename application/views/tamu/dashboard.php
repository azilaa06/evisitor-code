...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-title i { margin-right: 10px; color: #3b82f6; }
        .form-grid {
            display: grid;
        ...
        label { font-weight: 500; color: #374151; margin-bottom: 8px; font-size: 14px; }
        ...
        .btn-reset:hover { background: #dc2626; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(239, 68, 68, 0.3); }
        .btn-submit { background: #3b82f6; color: white; }
        .btn-submit:hover { background: #2563eb; transform: translateY(-2px); box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3); }
        .notice-section {
            background: #f1f5f9;
            border-radius: 8px;
            padding: 25px;
        ...
        .notice-title { font-weight: 600; color: #ef4444; margin-bottom: 15px; font-size: 16px; }
        .notice-list { list-style: none; color: #475569; font-size: 13px; line-height: 1.6; }
        .notice-list li { margin-bottom: 8px; position: relative; padding-left: 15px; }
        .notice-list li::before { content: "•"; color: #ef4444; position: absolute; left: 0; font-weight: bold; }
    </style>
</head>
<body>
    <main class="main-content">
        ...
        <div class="form-container">
            ...
            <form id="registrationForm" method="post" action="<?= base_url('kunjungan/submit') ?>">
                <div class="form-grid">
