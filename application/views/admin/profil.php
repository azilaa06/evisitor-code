...
<body>
    ...
    <main class="main-content">
        ...
        <div class="profil-container">
            ...
            <form class="profil-body" id="profilForm" method="post" action="<?= base_url('profil_admin/update'); ?>" enctype="multipart/form-data">
                <!-- Foto Profil -->
                <div class="profil-picture">
                    <div class="profile-avatar" id="profileAvatar">
                        <?php if (!empty($user->foto)): ?>
                            <img src="<?= base_url('uploads/profil/' . $user->foto); ?>" alt="Profil">
                        <?php else: ?>
    ...
    <script>
        ...
        deleteBtn.addEventListener('click', () => {
            if (confirm('Apakah Anda yakin ingin menghapus akun ini? Tindakan ini tidak dapat dibatalkan.')) {
                window.location.href = '<?= base_url('profil_admin/delete_account'); ?>';
            }
        });
    </script>
